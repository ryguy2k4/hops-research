...
# exlude = ['HOPS-363', 'HOPS-213', 'HOPS-75', 'HOPS-384', 'HOPS-173']
...
for i, field in df.iterrows():
    ...
    output_path = f"../results/m8_outflow_alignment/{target_name}_outflow.pdf"
...
ax.set_ylabel("count")
fig2.savefig("../results/m8_outflow_alignment/histogram.png")