...
The paper was published April 13, 2026 in the [Astrophysical Journal](https://doi.org/10.3847/1538-4357/ae4a29), available on [arXiv](https://arxiv.org/abs/2603.01347), and the analysis and data are preserved in an [Illinois Databank Repository](https://doi.org/10.13012/B2IDB-7093951_V1). Also check out the [NRAO Press Release](https://public.nrao.edu/news/most-close-pairs-of-stars-are-born-as-cosmic-twins/).
